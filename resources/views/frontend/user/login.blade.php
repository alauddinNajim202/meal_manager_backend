    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form action="{{ route('user.login.post') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password" name="password" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter your password">
            </div>
